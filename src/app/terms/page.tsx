...
export const metadata: Metadata = {
  title: "תקנון אתר | אורי שמאות רכוש",
  description:
    "תקנון השימוש באתר אורי שמאות רכוש – תנאי השימוש, אחריות, קניין רוחני וסמכות שיפוט.",
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
            ...
            <div className="space-y-10 text-base leading-relaxed text-body-color md:text-lg">
              <div>
                ...
                <div className="space-y-4">
                  <p>
                    ברוכים הבאים לאתר אורי שמאות רכוש (להלן: ״האתר״), המופעל על
