    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="כאן בשבילכם בכל רגע נתון"
            paragraph="צפו בסרטון קצר ולמדו איך אנחנו עוזרים לבעלי נכסים ולבעלי עסקים לקבל את הפיצוי המגיע להם – ללא כאב ראש וללא התעסקות מול חברת הביטוח."
            center
            mb="80px"
          />
        </div>
                  ...
                  <div className="absolute top-0 right-0 flex h-full w-full items-center justify-center">
                    ...
                    >
                      <svg
                        ...
                        height="18"
                        viewBox="0 0 16 18"
                        className="rtl-flip fill-current"
                      >
