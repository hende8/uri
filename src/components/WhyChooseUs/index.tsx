        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <SectionTitle
              ...
              title="אנחנו נלחמים על הפיצוי שלכם – לא חברת הביטוח"
              paragraph="אנחנו פועלים כסניגור המקצועי שלכם מול חברות הביטוח. רקע הנדסי-טכני ושיטות עבודה מדויקות שגיבשנו במערכי ביטחון ותקשורת מבטיחים שכל נזק מתועד, מוערך ומפוצה במלואו – בלי שתצטרכו להתמודד עם הבירוקרטיה לבד."
              mb="44px"
            />
